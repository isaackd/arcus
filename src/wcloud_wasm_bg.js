...
*/
export function make_wordcloud(text, width, height) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.make_wordcloud(ptr0, len0, width, height);
...
export function __wbg_newwithbyteoffsetandlength_a04f81daba99fdcb(arg0, arg1, arg2) {
    const ret = new Uint8ClampedArray(getObject(arg0), arg1 >>> 0, arg2 >>> 0);
    return addHeapObject(ret);
};

export function __wbg_new_03e65ab6ee0581bb(arg0) {
